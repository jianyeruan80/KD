...
.filter('stopTime', function() {
    ...
    .controller('TabCtrl', function($scope, $rootScope, $interval,$timeout, $ionicModal, $ionicLoading,localStorageService, $http, $location, $filter, $translate, localStorageService) {
...
$scope.openLicense=function(){
  ...
  $ionicModal.fromTemplateUrl('license.html', function($ionicModal){
      ...
      }, { scope : $scope,animation: 'slide-in-up' ,backdropClickToClose:false}).then(function(){
     $scope.license.show();
 });  
}
                   ...
                   if(jsonObj.Envelope.Body[type].Result.successful=="true"){
                                             if(type=="ClientInstanceLoginResponseType"){
                                              ...
                                              if(!jsonObj.Envelope.Body[type].appInstances.displaysName && $scope.runner){
                                                 ...
                                                 $scope.appInstances.enableDone="true";
        ...
        $scope.getData=function(){
            ...
            $scope.orderList=[];
             ...
             if($scope.runner){
                ...
                alert("Please Setting Kitchen Display!");
                return false;
             }
    ...
    .controller('RunnerCtrl', function($scope, $http, localStorageService, $rootScope, $location) {
        ...
        $scope.runnerUpdo = function() {
            ...
            if (!!runnerUpdoList) {
                ...
                console.log(tempRunnerUpdoList)
